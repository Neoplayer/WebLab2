...
<div class="header bg-dark py-2">
    <h3 class="text-light text-center">P33211 -- Аман Даниил, Нестерчук Павел -- 2151</h3>
</div>
        ...
        <form id="coordsForm" class="my-5 needs-validation" method="post" action="Controller" novalidate>
            ...
            <div class="form-row justify-content-center">
                ...
                <div class="form-group col-3 align-self-end">
                    ...
                    <input type="button" value="1" id="radius1" class="btn btn-dark" onclick="OnButtonClick(1)"/>
                    <input type="button" value="1.5" id="radius1.5" class="btn btn-dark" onclick="OnButtonClick(1.5)"/>
                    <input type="button" value="2" id="radius2" class="btn btn-dark" onclick="OnButtonClick(2)"/>
                    <input type="button" value="2.5" id="radius2.5" class="btn btn-dark" onclick="OnButtonClick(2.5)"/>
                    <input type="button" value="3" id="radius3" class="btn btn-dark" onclick="OnButtonClick(3)"/>
                    <input type="text" autocomplete="off" maxlength="17" id="radius" name="radius" class="form-control collapse" required>
                    <div class="invalid-tooltip" id="rTooltip">Выберите значение</div>
                </div>
            </div>
            <div class="form-row justify-content-center">
...
<script src="js/ButtonsController.js"></script>
<script>
